 ...
 * file in place, and appends an audit log entry to the StateStore.
 *
...
import type { PhaseTokenBreakdown, TuneLogEntry } from './types.js'
...
export class RoutingTuner {
  ...
  private readonly _eventEmitter: TypedEventBus
