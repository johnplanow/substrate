...
describe('AutoSupervisorOptions includes experiment flag (AC1)', () => {
  it('runSupervisorAction accepts experiment and maxExperiments options', async () => {
    const { runSupervisorAction } = await import('../../../cli/commands/supervisor.js')
    expect(typeof runSupervisorAction).toBe('function')
