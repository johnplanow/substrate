  ...
  .object({
    ...
    finalization: z
      .object({
        ...
        /**
         * H3.3 (AC2): 'ff-only' (default) refuses to merge when the base moved
         * since the story branched; 'three-way' restores the merge-commit
         * fallback (required for concurrent multi-story runs).
         */
